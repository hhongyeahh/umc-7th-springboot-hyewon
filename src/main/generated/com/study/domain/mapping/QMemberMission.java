...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    private static final long serialVersionUID = -374235078L;
    ...
    public final com.study.domain.QMember member;

    public final com.study.domain.QMission mission;

    public final EnumPath<com.study.domain.enums.MissionStatus> status = createEnum("status", com.study.domain.enums.MissionStatus.class);
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.member = inits.isInitialized("member") ? new com.study.domain.QMember(forProperty("member")) : null;
        this.mission = inits.isInitialized("mission") ? new com.study.domain.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
